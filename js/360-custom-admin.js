( function( $ ) {
    ...
    "use strict";        
            ...
            var $image_gallery_ids = $( '#wp360view_gallery' );
            var $product_images    = $( '#wp360-product-container' ).find( 'ul.wp360-product-images-wrap' );
            ...
            $product_images.sortable({
                ...
                update: function() {
                    ...
                    $( '#wp360-product-container' ).find( 'ul li.image' ).css( 'cursor', 'default' ).each( function() {
            ...
            // Remove images.
            $( '#wp360-product-container' ).on( 'click', 'a.delete', function() {
